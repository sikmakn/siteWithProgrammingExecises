...
}), ace.define("ace/mode/r", ["require", "exports", "module", "ace/unicode", "ace/range", "ace/lib/oop", "ace/mode/text", "ace/mode/text_highlight_rules", "ace/mode/r_highlight_rules", "ace/mode/matching_brace_outdent"], function (e, t, n) {
    "use strict";
    var r = e("../unicode"), i = e("../range").Range, s = e("../lib/oop"), o = e("./text").Mode,
        u = e("./text_highlight_rules").TextHighlightRules, a = e("./r_highlight_rules").RHighlightRules,
        f = e("./matching_brace_outdent").MatchingBraceOutdent, l = function () {
            this.HighlightRules = a, this.$outdent = new f, this.$behaviour = this.$defaultBehaviour
        };
    s.inherits(l, o), function () {
        this.lineCommentStart = "#", this.tokenRe = new RegExp("^[" + r.wordChars + "._]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + r.wordChars + "._]|s])+", "g"), this.$id = "ace/mode/r", this.snippetFileId = "ace/snippets/r"
