ace.define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
        ...
        s = e("./text_highlight_rules").TextHighlightRules, o = function () {
            ...
            this.$rules = {
                ...
                qqstring: [{
                    ...
                    token: "constant.language.escape",
                    regex: /\$\{[^"\}]+\}?/
                }, {token: "string", regex: '"{3,5}', next: "start"}, {token: "string", regex: ".+?"}],
                qstring: [{token: "constant.language.escape", regex: /\\(?:u[0-9A-Fa-f]{4}|.|$)/}, {
                    token: "string",
                    regex: "'{3,5}",
                    next: "start"
                }, {token: "string", regex: ".+?"}]
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./javascript").Mode, s = e("./groovy_highlight_rules").GroovyHighlightRules,
        o = function () {
