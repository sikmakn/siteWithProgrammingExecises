ace.define("ace/mode/io_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    "use strict";
        ...
        this.$rules = {
            start: [{
                ...
                push: [{
                    ...
                    regex: '"""',
                    next: "pop"
                }, {token: "constant.character.escape.io", regex: "\\\\."}, {defaultToken: "string.quoted.triple.io"}]
            }, {
                token: "punctuation.definition.string.begin.io",
                regex: '"',
                push: [{
                    ...
                    regex: '"',
                    next: "pop"
                }, {token: "constant.character.escape.io", regex: "\\\\."}, {defaultToken: "string.quoted.double.io"}]
            }, {
    ...
    s.metaData = {
        ...
        name: "Io",
        scopeName: "source.io"
    }, r.inherits(s, i), t.IoHighlightRules = s
...
}), ace.define("ace/mode/io", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/io_highlight_rules", "ace/mode/folding/cstyle"], function (e, t, n) {
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./io_highlight_rules").IoHighlightRules,
    ...
    r.inherits(u, i), function () {
        ...
        }, this.$id = "ace/mode/io", this.snippetFileId = "ace/snippets/io"
