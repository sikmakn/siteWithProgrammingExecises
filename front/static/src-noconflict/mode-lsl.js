ace.define("ace/mode/lsl_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    "use strict";
    ...
    function s() {
        ...
        this.$rules = {
            start: [{token: "comment.line.double-slash.lsl", regex: "\\/\\/.*$"}, {
...
}), ace.define("ace/mode/lsl", ["require", "exports", "module", "ace/mode/lsl_highlight_rules", "ace/mode/matching_brace_outdent", "ace/range", "ace/mode/text", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle", "ace/lib/oop"], function (e, t, n) {
    "use strict";
    ...
    f.inherits(l, o), function () {
        ...
        }, this.$id = "ace/mode/lsl", this.snippetFileId = "ace/snippets/lsl"
