ace.define("ace/mode/abc_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = function () {
        this.$rules = {
            start: [{
                ...
                regex: '[\\"!]\\^.*?[\\"!]',
                comment: "abc chord"
            }, {token: "string.quoted", regex: '[\\"!].*?[\\"!]', comment: "abc annotation"}]
        }, this.normalizeRules()
    };
    s.metaData = {
        fileTypes: ["abc"],
    ...
    }, r.inherits(s, i), t.ABCHighlightRules = s
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./abc_highlight_rules").ABCHighlightRules,
    ...
    r.inherits(u, i), function () {
        this.$id = "ace/mode/abc", this.snippetFileId = "ace/snippets/abc"
