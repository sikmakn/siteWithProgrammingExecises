ace.define("ace/mode/erlang_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    "use strict";
    var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = function () {
        this.$rules = {
            start: [{include: "#module-directive"}, {include: "#import-export-directive"}, {include: "#behaviour-directive"}, {include: "#record-directive"}, {include: "#define-directive"}, {include: "#macro-directive"}, {include: "#directive"}, {include: "#function"}, {include: "#everything-else"}],
            "#atom": [{
            ...
            }, {token: "constant.other.symbol.unquoted.erlang", regex: "[a-z][a-zA-Z\\d@_]*"}],
            "#behaviour-directive": [{
            ...
            "#binary": [{
                ...
                push: [{
                    ...
                    regex: "(,)|(:)"
                }, {include: "#internal-type-specifiers"}, {include: "#everything-else"}, {defaultToken: "meta.structure.binary.erlang"}]
            }],
            "#character": [{
            ...
            "#define-directive": [{
                ...
                push: [{
                    ...
                    regex: "(\\))(\\s*)(\\.)",
                    next: "pop"
                }, {include: "#everything-else"}, {defaultToken: "meta.directive.define.erlang"}]
            }, {
                ...
                push: [{
                    ...
                    push: [{
                        ...
                        regex: "(\\))(\\s*)(,)",
                        next: "pop"
                    }, {token: "punctuation.separator.parameters.erlang", regex: ","}, {include: "#everything-else"}]
                }, {
            ...
            "#directive": [{
                ...
                push: [{
                    ...
                    regex: "(\\)?)(\\s*)(\\.)",
                    next: "pop"
                }, {include: "#everything-else"}, {defaultToken: "meta.directive.erlang"}]
            }, {
            ...
            "#everything-else": [{include: "#comment"}, {include: "#record-usage"}, {include: "#macro-usage"}, {include: "#expression"}, {include: "#keyword"}, {include: "#textual-operator"}, {include: "#function-call"}, {include: "#tuple"}, {include: "#list"}, {include: "#binary"}, {include: "#parenthesized-expression"}, {include: "#character"}, {include: "#number"}, {include: "#atom"}, {include: "#string"}, {include: "#symbolic-operator"}, {include: "#variable"}],
            "#expression": [{
                ...
                push: [{
                    ...
                    regex: "\\bend\\b",
                    next: "pop"
                }, {include: "#internal-expression-punctuation"}, {include: "#everything-else"}, {defaultToken: "meta.expression.if.erlang"}]
            }, {
                ...
                push: [{
                    ...
                    regex: "\\bend\\b",
                    next: "pop"
                }, {include: "#internal-expression-punctuation"}, {include: "#everything-else"}, {defaultToken: "meta.expression.case.erlang"}]
            }, {
                ...
                push: [{
                    ...
                    regex: "\\bend\\b",
                    next: "pop"
                }, {include: "#internal-expression-punctuation"}, {include: "#everything-else"}, {defaultToken: "meta.expression.receive.erlang"}]
            }, {
                ...
                regex: "\\bfun\\b",
                push: [{token: "keyword.control.end.erlang", regex: "\\bend\\b", next: "pop"}, {
                    token: "text",
                    regex: "(?=\\()",
                    push: [{
                ...
                }, {include: "#everything-else"}, {defaultToken: "meta.expression.fun.erlang"}]
            }, {
                ...
                push: [{
                    ...
                    regex: "\\bend\\b",
                    next: "pop"
                }, {include: "#internal-expression-punctuation"}, {include: "#everything-else"}, {defaultToken: "meta.expression.try.erlang"}]
            }, {
                ...
                push: [{
                    ...
                    regex: "\\bend\\b",
                    next: "pop"
                }, {include: "#internal-expression-punctuation"}, {include: "#everything-else"}, {defaultToken: "meta.expression.begin.erlang"}]
            }, {
                ...
                push: [{
                    ...
                    regex: "\\bend\\b",
                    next: "pop"
                }, {include: "#everything-else"}, {defaultToken: "meta.expression.query.erlang"}]
            }],
            "#function": [{
                ...
                push: [{
                    ...
                    push: [{
                        ...
                        regex: ";|(?=\\.)",
                        next: "pop"
                    }, {include: "#parenthesized-expression"}, {include: "#internal-function-parts"}]
                }, {include: "#everything-else"}, {defaultToken: "meta.function.erlang"}]
            }],
            "#function-call": [{
            ...
            "#import-export-directive": [{
                ...
                push: [{
                    ...
                    regex: "(\\))(\\s*)(\\.)",
                    next: "pop"
                }, {include: "#internal-function-list"}, {defaultToken: "meta.directive.import.erlang"}]
            }, {
                ...
                push: [{
                    ...
                    regex: "(\\))(\\s*)(\\.)",
                    next: "pop"
                }, {include: "#internal-function-list"}, {defaultToken: "meta.directive.export.erlang"}]
            }],
            ...
            "#internal-function-list": [{
                ...
                }, {include: "#everything-else"}, {defaultToken: "meta.structure.list.function.erlang"}]
            }],
            "#internal-function-parts": [{
                ...
                }, {token: "punctuation.separator.guards.erlang", regex: ",|;"}, {include: "#everything-else"}]
            }, {token: "punctuation.separator.expressions.erlang", regex: ","}, {include: "#everything-else"}],
            "#internal-record-body": [{
                ...
                push: [{
                    ...
                    regex: "([a-z][a-zA-Z\\d@_]*|'[^']*')(\\s*)((?:,)?)"
                }, {include: "#everything-else"}, {defaultToken: "meta.structure.record.erlang"}]
            }],
            ...
            "#list": [{
                ...
                push: [{
                    ...
                    token: "punctuation.separator.list.erlang",
                    regex: "\\||\\|\\||,"
                }, {include: "#everything-else"}, {defaultToken: "meta.structure.list.erlang"}]
            }],
            "#macro-directive": [{
            ...
            "#number": [{
                ...
                push: [{
                    ...
                    regex: "\\d+#[\\da-zA-Z]+"
                }, {token: "constant.numeric.integer.decimal.erlang", regex: "\\d+"}]
            }],
            "#parenthesized-expression": [{
                ...
                push: [{
                    ...
                    regex: "\\)",
                    next: "pop"
                }, {include: "#everything-else"}, {defaultToken: "meta.expression.parenthesized"}]
            }],
            "#record-directive": [{
                ...
                push: [{
                    ...
                    regex: "(\\})(\\s*)(\\))(\\s*)(\\.)",
                    next: "pop"
                }, {include: "#internal-record-body"}, {defaultToken: "meta.directive.record.erlang"}]
            }],
            "#record-usage": [{
                ...
                push: [{
                    ...
                    regex: "\\}",
                    next: "pop"
                }, {include: "#internal-record-body"}, {defaultToken: "meta.record-usage.erlang"}]
            }],
            "#string": [{
            ...
            "#tuple": [{
                ...
                push: [{
                    ...
                    regex: ","
                }, {include: "#everything-else"}, {defaultToken: "meta.structure.tuple.erlang"}]
            }],
            "#variable": [{
    ...
    }, r.inherits(s, i), t.ErlangHighlightRules = s
...
}), ace.define("ace/mode/erlang", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/erlang_highlight_rules", "ace/mode/folding/cstyle"], function (e, t, n) {
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./erlang_highlight_rules").ErlangHighlightRules,
    ...
    r.inherits(u, i), function () {
        this.lineCommentStart = "%", this.blockComment = null, this.$id = "ace/mode/erlang", this.snippetFileId = "ace/snippets/erlang"
