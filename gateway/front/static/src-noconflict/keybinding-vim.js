ace.define("ace/keyboard/vim", ["require", "exports", "module", "ace/range", "ace/lib/event_emitter", "ace/lib/dom", "ace/lib/oop", "ace/lib/keys", "ace/lib/event", "ace/search", "ace/lib/useragent", "ace/search_highlight", "ace/commands/multi_select_commands", "ace/mode/text", "ace/multi_select"], function (e, t, n) {
    ...
    function T(e) {
        e.setOption("disableInput", !0), e.setOption("showCursorWhenSelecting", !1), v.signal(e, "vim-mode-change", {mode: "normal"}), e.on("cursorActivity", er), rt(e), v.on(e.getInputField(), "paste", _(e))
    }

    function N(e) {
        e.setOption("disableInput", !1), e.off("cursorActivity", er), v.off(e.getInputField(), "paste", _(e)), e.state.vim = null
    }

    function C(e, t) {
        this == v.keyMap.vim && v.rmClass(e.getWrapperElement(), "cm-fat-cursor"), (!t || t.attach != k) && N(e)
    }

    function k(e, t) {
        this == v.keyMap.vim && v.addClass(e.getWrapperElement(), "cm-fat-cursor"), (!t || t.attach != k) && T(e)
    }
    ...
    function M(e) {
        ...
        return r ? (V(n) && (t[t.length - 1] = n.toLowerCase()), "<" + t.join("-") + ">") : !1
    }

    function _(e) {
        var t = e.state.vim;
        return t.onPasteFn || (t.onPasteFn = function () {
            t.insertMode || (e.setCursor(Tt(e.getCursor(), 0, 1)), wt.enterInsertMode(e, {}, t))
        }), t.onPasteFn
    }
    ...
    function Y(e, t, n, r) {
        ...
        i.callback ? (s !== "local" && i.callback(t, undefined), s !== "global" && n && i.callback(t, n)) : (s !== "local" && (i.value = i.type == "boolean" ? !!t : t), s !== "global" && n && (n.state.vim.options[e] = {value: t}))
    }
    ...
    function nt() {
        this.latestRegister = undefined, this.isPlaying = !1, this.isRecording = !1, this.replaySearchQueries = [], this.onRecordingDone = undefined, this.lastInsertModeChanges = tt()
    }
    ...
    function ht(e) {
        this.registers = e, this.unnamedRegister = e['"'] = new lt, e["."] = new lt, e[":"] = new lt, e["/"] = new lt
    }
    ...
    function St(e, t, n) {
        var r = Math.min(Math.max(e.firstLine(), t.line), e.lastLine()), i = Ht(e, r) - 1;
        i = n ? i + 1 : i;
    ...
    function Tt(e, t, n) {
        return typeof t == "object" && (n = t.ch, t = t.line), S(e.line + t, e.ch + n)
    }
    ...
    function Nt(e, t, n, r) {
        ...
        for (var u = 0; u < t.length; u++) {
            var a = t[u];
            if (n == "insert" && a.context != "insert" || a.context && a.context != n || r.operator && a.type == "action" || !(i = Ct(e, a.keys))) continue;
    ...
    function _t(e, t) {
        return arguments.length > 2 && (t = _t.apply(undefined, Array.prototype.slice.call(arguments, 1))), Mt(e, t) ? e : t
    }

    function Dt(e, t) {
        return arguments.length > 2 && (t = Dt.apply(undefined, Array.prototype.slice.call(arguments, 1))), Mt(e, t) ? t : e
    }

    function Pt(e, t, n) {
        var r = Mt(e, t), i = Mt(t, n);
        return r && i
    }
    ...
    function Ft(e, t, n) {
        var r = Ht(e, t), i = (new Array(n - r + 1)).join(" ");
        e.setCursor(S(t, r)), e.replaceRange(i, e.getCursor())
    }

    function It(e, t) {
        var n = [], r = e.listSelections(), i = At(e.clipPos(t)), s = !Ot(t, i), o = e.getCursor("head"), u = Rt(r, o),
            a = Ot(r[u].head, r[u].anchor), f = r.length - 1, l = f - u > u ? f : 0, c = r[l].anchor,
            h = Math.min(c.line, i.line), p = Math.max(c.line, i.line), d = c.ch, v = i.ch, m = r[l].head.ch - d,
            g = v - d;
    ...
    function Rt(e, t, n) {
        for (var r = 0; r < e.length; r++) {
            var i = n != "head" && Ot(e[r].anchor, t), s = n != "anchor" && Ot(e[r].head, t);
            if (i || s) return r
        }
        return -1
    }
    ...
    function Ut(e, t) {
        var n = t.lastSelection, r = function () {
            var t = e.listSelections(), n = t[0], r = t[t.length - 1], i = Mt(n.anchor, n.head) ? n.anchor : n.head,
            ...
            if (i) {
                ...
                for (var a = t.line; a < r.line; a++) {
                    var f = S(a, t.ch), l = S(a, r.ch), c = {anchor: f, head: l};
                    u.push(c)
                }
                e.setSelections(u)
            } else {
                ...
                r = {
                    line: r.line + d,
                    ch: d ? r.ch : v + r.ch
                }, n.visualLine && (t = S(t.line, 0), r = S(r.line, Ht(e, r.line))), e.setSelection(t, r)
            }
            return [t, r]
        };
    ...
    function Wt(e, t, n) {
        ...
        return Mt(n, t) && (o = n, n = t, t = o), Mt(i, s) ? (i = _t(t, i), s = Dt(s, n)) : (s = _t(t, s), i = Dt(i, n), i = Tt(i, 0, -1), i.ch == -1 && i.line != e.firstLine() && (i = S(i.line - 1, Ht(e, i.line - 1)))), [s, i]
    }

    function Xt(e, t, n) {
        var r = e.state.vim;
        t = t || r.sel;
        var n = n || r.visualLine ? "line" : r.visualBlock ? "block" : "char", i = Vt(e, t, n);
        e.setSelections(i.ranges, i.primary), tr(e)
    }

    function Vt(e, t, n, r) {
        var i = At(t.head), s = At(t.anchor);
        if (n == "char") {
            var o = !r && !Mt(t.head, t.anchor) ? 1 : 0, u = Mt(t.head, t.anchor) ? 1 : 0;
            return i = Tt(t.head, 0, o), s = Tt(t.anchor, 0, u), {ranges: [{anchor: s, head: i}], primary: 0}
        }
        if (n == "line") {
        ...
        if (n == "block") {
            var f = Math.min(s.line, i.line), l = Math.min(s.ch, i.ch), c = Math.max(s.line, i.line),
                h = Math.max(s.ch, i.ch) + 1, p = c - f + 1, d = i.line == f ? 0 : p - 1, v = [];
            for (var m = 0; m < p; m++) v.push({anchor: S(f + m, l), head: S(f + m, h)});
    ...
    function $t(e) {
        ...
        return e.getSelection().length == 1 && (t = _t(t, e.getCursor("anchor"))), t
    }

    function Jt(e, t) {
        var n = e.state.vim;
        t !== !1 && e.setCursor(St(e, n.sel.head)), zt(e, n), n.visualMode = !1, n.visualLine = !1, n.visualBlock = !1, v.signal(e, "vim-mode-change", {mode: "normal"}), n.fakeCursor && n.fakeCursor.clear()
    }
    ...
    function Kt(e, t, n) {
        ...
        if (/\n\s*$/.test(r)) {
            ...
            i.pop();
            var s;
            for (var s = i.pop(); i.length > 0 && s && $(s); s = i.pop()) n.line--, n.ch = 0;
    ...
    function Yt(e, t, n, r, i) {
        var s = $t(e), o = e.getLine(s.line), u = s.ch, a = i ? P[0] : H[0];
        while (!a(o.charAt(u))) {
            u++;
    ...
    function en(e, t) {
        it.lastCharacterSearch.increment = e, it.lastCharacterSearch.forward = t.forward, it.lastCharacterSearch.selectedCharacter = t.selectedCharacter
    }

    function rn(e, t, n, r) {
        var i = At(e.getCursor()), s = n ? 1 : -1, o = n ? e.lineCount() : -1, u = i.ch, a = i.line, f = e.getLine(a),
            l = {
                lineText: f,
                nextCh: f.charAt(u),
                lastCh: null,
        ...
        if (!c) return i;
        var h = nn[c].init, p = nn[c].isComplete;
        h && h(l);
        while (a !== o && t) {
    ...
    function sn(e, t, n, r, i) {
        var s = t.line, o = t.ch, u = e.getLine(s), a = n ? 1 : -1, f = r ? H : P;
        if (i && u == "") {
            s += a, u = e.getLine(s);
    ...
    function on(e, t, n, r, i, s) {
        ...
        return r && !i ? (!h && (p.from != o.ch || p.line != o.line) && (d = u.pop()), S(d.line, d.from)) : r && i ? S(d.line, d.to - 1) : !r && i ? (!h && (p.to != o.ch || p.line != o.line) && (d = u.pop()), S(d.line, d.to)) : S(d.line, d.from)
    }
    ...
    function cn(e, t, n, r, i) {
        ...
        for (l = s; l > o; l--) if (!i || c(l) == m || l == s) if (h(l, -1, !0)) break;
    ...
    function hn(e, t, n, r) {
        ...
        function s(e, t, n, r) {
            var s = e.getLine(t), o = s === "", u = {line: s, ln: t, pos: n, dir: r}, a = {ln: u.ln, pos: u.pos},
                f = u.line === "";
            i(e, u);
            while (u.line !== null) {
                a.ln = u.ln, a.pos = u.pos;
                if (u.line === "" && !f) return {ln: u.ln, pos: u.pos};
                if (o && u.line !== "" && !$(u.line[u.pos])) return {ln: u.ln, pos: u.pos};
                J(u.line[u.pos]) && !o && (u.pos === u.line.length - 1 || $(u.line[u.pos + 1])) && (o = !0), i(e, u)
            }
            var s = e.getLine(a.ln);
            a.pos = 0;
            for (var l = s.length - 1; l >= 0; --l) if (!$(s[l])) {
                a.pos = l;
                break
            }
            return a
        ...
        function o(e, t, n, r) {
            var s = e.getLine(t), o = {line: s, ln: t, pos: n, dir: r}, u = {ln: o.ln, pos: null}, a = o.line === "";
            i(e, o);
            while (o.line !== null) {
                if (o.line === "" && !a) return u.pos !== null ? u : {ln: o.ln, pos: o.pos};
                if (!(!J(o.line[o.pos]) || u.pos === null || o.ln === u.ln && o.pos + 1 === u.pos)) return u;
                o.line !== "" && !$(o.line[o.pos]) && (a = !1, u = {ln: o.ln, pos: o.pos}), i(e, o)
            }
            var s = e.getLine(u.ln);
            u.pos = 0;
            for (var f = 0; f < s.length; ++f) if (!$(s[f])) {
                u.pos = f;
                break
            }
            return u
        ...
        while (n > 0) r < 0 ? u = o(e, u.ln, u.pos, r) : u = s(e, u.ln, u.pos, r), n--;
        return S(u.ln, u.pos)
    }
    ...
    function pn(e, t, n, r) {
        var i = t, s, o, u = {
            ...
            f = e.getLine(i.line).charAt(i.ch), l = f === a ? 1 : 0;
        s = e.scanForBracket(S(i.line, i.ch + l), -1, undefined, {bracketRegex: u}), o = e.scanForBracket(S(i.line, i.ch + l), 1, undefined, {bracketRegex: u});
    ...
    function dn(e, t, n, r) {
        var i = At(t), s = e.getLine(i.line), o = s.split(""), u, a, f, l, c = o.indexOf(n);
        ...
        return !u || !a ? {start: i, end: i} : (r && (--u, ++a), {start: S(i.line, u), end: S(i.line, a)})
    }
    ...
    function gn(e, t, n, r, i) {
        e.openDialog ? e.openDialog(t, r, {
            ...
            selectValueOnOpen: !1,
            onClose: function () {
                e.state.vim && (e.state.vim.status = "", e.ace.renderer.$loop.schedule(e.ace.renderer.CHANGE_CURSOR))
            }
        }) : r(prompt(n, ""))
    }
    ...
    function Tn(e) {
        ...
        for (var r = -1; r < e.length; r++) {
            ...
            xn[i + s] ? (n.push(xn[i + s]), r++) : t ? (n.push(i), t = !1) : i === "\\" ? (t = !0, X(s) || s === "$" ? n.push("$") : s !== "/" && s !== "\\" && n.push("\\")) : (i === "$" && n.push("$"), n.push(i), s === "/" && n.push("\\"))
        }
        return n.join("")
    }
    ...
    function Cn(e) {
        ...
        while (!t.eol()) {
            ...
            var r = !1;
            for (var i in Nn) if (t.match(i, !0)) {
                r = !0, n.push(Nn[i]);
                break
            }
            r || n.push(t.next())
    ...
    function An(e, t) {
        var n = '<span style="font-family: monospace; white-space: pre">' + (e || "") + '<input type="text" autocorrect="off" autocapitalize="none" autocomplete="off"></span>';
        return t && (n += ' <span style="color: #888">' + t + "</span>"), n
    }

    function Mn(e, t) {
        var n = (t.prefix || "") + " " + (t.desc || ""), r = An(t.prefix, t.desc);
    ...
    function Hn(e, t) {
        var n = mn(e), r = n.getOverlay();
        if (!r || t != r.query) r && e.removeOverlay(r), r = Pn(t), e.addOverlay(r), e.showMatchesOnScrollbar && (n.getScrollbarAnnotate() && n.getScrollbarAnnotate().clear(), n.setScrollbarAnnotate(e.showMatchesOnScrollbar(t))), n.setOverlay(r)
    }
    ...
    function jn(e) {
        var t = mn(e);
        e.removeOverlay(mn(e).getOverlay()), t.setOverlay(null), t.getScrollbarAnnotate() && (t.getScrollbarAnnotate().clear(), t.setScrollbarAnnotate(null))
    }

    function Fn(e, t, n) {
        return typeof e != "number" && (e = e.line), t instanceof Array ? K(e, t) : n ? e >= t && e <= n : e == t
    }
    ...
    function Kn(e, t, n, r) {
        ...
        if (r == ":") {
            i.keyBuffer[0] && Wn.processCommand(e, i.keyBuffer[0]), n.isPlaying = !1;
            return
        }
        var s = i.keyBuffer, o = 0;
        ...
        for (var u = 0; u < s.length; u++) {
            ...
            while (a) {
                ...
                if (t.insertMode) {
                    ...
                    it.macroModeState.lastInsertModeChanges.changes = c, or(e, c, 1), Vn(e)
                }
            }
        }
        n.isPlaying = !1
    ...
    function Qn(e, t) {
        ...
        var n = e.latestRegister, r = it.registerController.getRegister(n);
        r && r.pushText(t)
    }

    function Gn(e) {
        if (e.isPlaying) return;
        var t = e.latestRegister, n = it.registerController.getRegister(t);
    ...
    function Zn(e, t) {
        var n = it.macroModeState, r = n.lastInsertModeChanges;
    ...
    function tr(e) {
        var t = e.state.vim, n = St(e, At(t.sel.head)), r = Tt(n, 0, 1);
        t.fakeCursor && t.fakeCursor.clear(), t.fakeCursor = e.markText(n, r, {className: "cm-animate-fat-cursor"})
    }

    function nr(e, t, n) {
        var r = e.getCursor("anchor"), i = e.getCursor("head");
        t.visualMode && !e.somethingSelected() ? Jt(e, !1) : !t.visualMode && !t.insertMode && e.somethingSelected() && (t.visualMode = !0, t.visualLine = !1, v.signal(e, "vim-mode-change", {mode: "visual"}));
        if (t.visualMode) {
            var s = Mt(i, r) ? 0 : -1, o = Mt(i, r) ? -1 : 0;
            i = Tt(i, 0, s), r = Tt(r, 0, o), t.sel = {
                anchor: r,
                head: i
            }, fn(e, t, "<", _t(i, r)), fn(e, t, ">", Dt(i, r))
    ...
    function ir(e) {
        function i() {
            return n.maybeReset && (n.changes = [], n.maybeReset = !1), n.changes.push(new rr(r)), !0
        }

        var t = it.macroModeState, n = t.lastInsertModeChanges, r = v.keyName(e);
        if (!r) return;
    ...
    function or(e, t, n) {
        ...
        var i = e.getCursor("head"), s = it.macroModeState.lastInsertModeChanges.visualBlock;
        s && (qt(e, i, s + 1), n = e.listSelections().length, e.setCursor(i));
        for (var o = 0; o < n; o++) {
            s && e.setCursor(Tt(i, o, 0));
            for (var u = 0; u < t.length; u++) {
                var a = t[u];
                if (a instanceof rr) v.lookupKey(a.keyName, "vim-insert", r); else if (typeof a == "string") {
                    var f = e.getCursor();
                    e.replaceRange(a, f, f)
                } else {
                    var l = e.getCursor(), c = Tt(l, 0, a[0].length);
    ...
    function ar(e, t, n) {
        t.length > 1 && t[0] == "n" && (t = t.replace("numpad", "")), t = ur[t] || t;
        var r = "";
    ...
    function lr(e) {
        ...
        return Object.keys(e).forEach(function (n) {
            var r = e[n];
            Array.isArray(r) ? r = r.slice() : r && typeof r == "object" && r.constructor != Object && (r = lr(r)), t[n] = r
        }), e.sel && (t.sel = {head: e.sel.head && At(e.sel.head), anchor: e.sel.anchor && At(e.sel.anchor)}), t
    }

    function cr(e, t, n) {
        var r = !1, i = x.maybeInitVimState_(e), s = i.visualBlock || i.wasInVisualBlock, o = e.ace.inMultiSelectMode;
        i.wasInVisualBlock && !o ? i.wasInVisualBlock = !1 : o && i.visualBlock && (i.wasInVisualBlock = !0);
        if (t == "<Esc>" && !i.insertMode && !i.visualMode && o) e.ace.exitMultiSelectMode(); else if (s || !o || e.ace.inVirtualSelectionMode) r = x.handleKey(e, t, n); else {
            var u = lr(i);
            e.operation(function () {
                e.ace.forEachSelection(function () {
                    ...
                    var s = e.getCursor("head"), o = e.getCursor("anchor"), a = Mt(s, o) ? 0 : -1,
                        f = Mt(s, o) ? -1 : 0;
                    s = Tt(s, 0, a), o = Tt(o, 0, f), e.state.vim.sel.head = s, e.state.vim.sel.anchor = o, r = fr(e, t, n), i.$desiredColumn = e.state.vim.lastHPos == -1 ? null : e.state.vim.lastHPos, e.virtualSelectionMode() && (e.state.vim = lr(u))
                }), e.curOp.cursorActivity && !r && (e.curOp.cursorActivity = !1)
            }, !0)
        }
        return r && !i.visualMode && !i.insert && i.visualMode != e.somethingSelected() && nr(e, i, !0), r
    }
    ...
    var i = e("../range").Range, s = e("../lib/event_emitter").EventEmitter, o = e("../lib/dom"), u = e("../lib/oop"),
        a = e("../lib/keys"), f = e("../lib/event"), l = e("../search").Search, c = e("../lib/useragent"),
        h = e("../search_highlight").SearchHighlight, p = e("../commands/multi_select_commands"),
    ...
    v.Pos = function (e, t) {
    ...
    }, v.keyMap = {}, v.addClass = v.rmClass = function () {
    }, v.e_stop = v.e_preventDefault = f.stopEvent, v.keyName = function (e) {
        ...
        u.implement(v.prototype, s), this.destroy = function () {
            ...
            var t = {text: e.action[0] == "i" ? e.lines : []}, n = this.curOp = this.curOp || {};
            ...
            typeof e == "object" && (t = e.ch, e = e.line), this.ace.inVirtualSelectionMode || this.ace.exitMultiSelectMode(), this.ace.session.unfold({
                row: e,
                column: t
            ...
            var t = e.action == "insert", n = e.start, r = e.end, s = (r.row - n.row) * (t ? 1 : -1),
        ...
        e.prototype.clear = function () {
            ...
            if (t == "local") {
                var r = this.ace.renderer, n = this.ace.session.documentToScreenPosition(e.line, e.ch),
                    i = r.layerConfig.lineHeight, s = r.layerConfig.characterWidth, o = i * n.row;
        ...
        this.setOption = function (e, n) {
            ...
            var i = r.bracketRegex.source, s = /paren|text|operator|tag/;
            if (t == 1) var o = this.ace.session.$findClosingBracket(i.slice(1, 2), m(e), s); else var o = this.ace.session.$findOpeningBracket(i.slice(-2, -1), {
                row: e.line,
                column: e.ch + 1
            }, s);
            return o && {pos: g(o)}
            ...
            e == "indentAuto" ? this.ace.execCommand("autoindent") : console.log(e + " is not implemented")
        }
    }.call(v.prototype);
        ...
        v.defineExtension("openDialog", function (n, r, i) {
            function a(e) {
                if (typeof e == "string") f.value = e; else {
                    ...
                    u.state.dialog = null, o = !0, s.parentNode.removeChild(s), u.focus(), i.onClose && i.onClose(s)
                }
            }

            if (this.virtualSelectionMode()) return;
            i || (i = {}), t(this, null);
            var s = e(this, n, i.bottom), o = !1, u = this;
            this.state.dialog = s;
            var f = s.getElementsByTagName("input")[0], l;
            if (f) i.value && (f.value = i.value, i.selectValueOnOpen !== !1 && f.select()), i.onInput && v.on(f, "input", function (e) {
    ...
    var b = [{keys: "<Left>", type: "keyToKey", toKeys: "h"}, {
        ...
        toKeys: "b",
        context: "normal"
    }, {keys: "<C-n>", type: "keyToKey", toKeys: "j"}, {keys: "<C-p>", type: "keyToKey", toKeys: "k"}, {
        keys: "<C-[>",
        type: "keyToKey",
        toKeys: "<Esc>"
        ...
        keys: ":",
        type: "ex"
    }], w = b.length, E = [{name: "colorscheme", shortName: "colo"}, {name: "map"}, {name: "imap", shortName: "im"}, {
        name: "nmap",
        shortName: "nm"
    }, {name: "vmap", shortName: "vm"}, {name: "unmap"}, {name: "write", shortName: "w"}, {
        name: "undo",
        shortName: "u"
    }, {name: "redo", shortName: "red"}, {name: "set", shortName: "se"}, {
        name: "set",
        shortName: "se"
    }, {name: "setlocal", shortName: "setl"}, {name: "setglobal", shortName: "setg"}, {
        name: "sort",
        shortName: "sor"
    }, {name: "substitute", shortName: "s", possiblyAsync: !0}, {name: "nohlsearch", shortName: "noh"}, {
        name: "yank",
        shortName: "y"
    ...
    }, {name: "global", shortName: "g"}], S = v.Pos, x = function () {
        return ut
    };
    ...
    var A = {Shift: "S", Ctrl: "C", Alt: "A", Cmd: "D", Mod: "A"},
        O = {Enter: "CR", Backspace: "BS", Delete: "Del", Insert: "Ins"}, D = /[\d]/, P = [v.isWordChar, function (e) {
            return e && !v.isWordChar(e) && !/\s/.test(e)
        }], H = [function (e) {
            return /\S/.test(e)
        }], j = B(65, 26), F = B(97, 26), I = B(48, 10), q = [].concat(j, F, I, ["<", ">"]),
        R = [].concat(j, F, I, ["-", '"', ".", ":", "/"]), Q = {};
    ...
    var it, ot, ut = {
        ...
        defineEx: function (e, t, n) {
            ...
            zn[e] = n, Wn.commandMap_[t] = {name: e, shortName: t, type: "api"}
        },
        ...
        findKey: function (e, t, n) {
            ...
            function s() {
                if (t == "<Esc>") return ft(e), r.visualMode ? Jt(e) : r.insertMode && Vn(e), !0
            }
            ...
            function u() {
                if (s()) return !0;
                var n = r.inputState.keyBuffer = r.inputState.keyBuffer + t, i = t.length == 1,
                    o = dt.matchCommand(n, b, r.inputState, "insert");
                while (n.length > 1 && o.type != "full") {
                    var n = r.inputState.keyBuffer = n.slice(1), u = dt.matchCommand(n, b, r.inputState, "insert");
                    u.type != "none" && (o = u)
                }
                if (o.type == "none") return ft(e), !1;
                if (o.type == "partial") return ot && window.clearTimeout(ot), ot = window.setTimeout(function () {
                    r.insertMode && r.inputState.keyBuffer && ft(e)
                }, Z("insertModeEscKeysTimeout")), !i;
            ...
            function a() {
                ...
                var o = /^(\d*)(.*)$/.exec(n);
                if (!o) return ft(e), !1;
                var u = r.visualMode ? "visual" : "normal", a = dt.matchCommand(o[2] || o[1], b, r.inputState, u);
            ...
            return r.insertMode ? f = u() : f = a(), f === !1 ? undefined : f === !0 ? function () {
                ...
                return e.operation(function () {
                    e.curOp.isVimOp = !0;
                    try {
                        f.type == "keyToKey" ? o(f.toKeys) : dt.processCommand(e, r, f)
                    } catch (t) {
                        throw e.state.vim = undefined, rt(e), v.Vim.suppressErrorLogging || console.log(t), t
                    }
                    return !0
                })
            }
        ...
        pushText: function (e, t, n, r, i) {
            ...
            if (!s) {
                switch (t) {
                    ...
                    case"delete":
                    case"change":
                        n.indexOf("\n") == -1 ? this.registers["-"] = new lt(n, r) : (this.shiftNumericRegisters_(), this.registers[1] = new lt(n, r))
                }
            ...
            return this.isValidRegister(e) ? (e = e.toLowerCase(), this.registers[e] || (this.registers[e] = new lt), this.registers[e]) : this.unnamedRegister
    ...
    var dt = {
        matchCommand: function (e, t, n, r) {
            ...
            t.inputState.motion = n.motion, t.inputState.motionArgs = xt(n.motionArgs), this.evalInput(e, t)
            ...
            r.operator = n.operator, r.operatorArgs = xt(n.operatorArgs), n.exitVisualBlock && (t.visualBlock = !1, Xt(e)), t.visualMode && this.evalInput(e, t)
        }, processOperatorMotion: function (e, t, n) {
            var r = t.visualMode, i = xt(n.operatorMotionArgs);
            i && r && i.visualLine && (t.visualLine = !0), this.processOperator(e, t, n), r || this.processMotion(e, t, n)
        }, processAction: function (e, t, n) {
            var r = t.inputState, i = r.getRepeat(), s = !!i, o = xt(n.actionArgs) || {};
            r.selectedCharacter && (o.selectedCharacter = r.selectedCharacter), n.operator && this.processOperator(e, t, n), n.motion && this.processMotion(e, t, n), (n.motion || n.operator) && this.evalInput(e, t), o.repeat = i || 1, o.repeatIsExplicit = s, o.registerName = r.registerName, ft(e), t.lastMotion = null, n.isEdit && this.recordLastEdit(t, r, n), wt[n.action](e, o, t)
        }, processSearch: function (e, t, n) {
            function a(r, i, s) {
                it.searchHistoryController.pushInput(r), it.searchHistoryController.reset();
                try {
                    Dn(e, r, i, s)
                } catch (o) {
            ...
            function l(t, n, i) {
                var s = v.keyName(t), o, a;
                s == "Up" || s == "Down" ? (o = s == "Up" ? !0 : !1, a = t.target ? t.target.selectionEnd : 0, n = it.searchHistoryController.nextMatch(n, o) || "", i(n), a && t.target && (t.target.selectionEnd = t.target.selectionStart = Math.min(a, t.target.value.length))) : s != "Left" && s != "Right" && s != "Ctrl" && s != "Alt" && s != "Shift" && it.searchHistoryController.reset();
                var f;
                try {
                    f = Dn(e, n, !0, !0)
                } catch (t) {
                }
                f ? e.scrollIntoView(Bn(e, !r, f), 30) : (jn(e), e.scrollTo(u.left, u.top))
            }

            function c(t, n, r) {
                var i = v.keyName(t);
                i == "Esc" || i == "Ctrl-C" || i == "Ctrl-[" || i == "Backspace" && n == "" ? (it.searchHistoryController.pushInput(n), it.searchHistoryController.reset(), Dn(e, o), jn(e), e.scrollTo(u.left, u.top), v.e_stop(t), ft(e), r(), e.focus()) : i == "Up" || i == "Down" ? v.e_stop(t) : i == "Ctrl-U" && (v.e_stop(t), r(""))
            }

            if (!e.getSearchCursor) return;
            var r = n.searchArgs.forward, i = n.searchArgs.wholeWordOnly;
            mn(e).setReversed(!r);
            var s = r ? "/" : "?", o = mn(e).getQuery(), u = e.getScrollInfo();
            switch (n.searchArgs.querySrc) {
                case"prompt":
                    ...
                    if (h.isPlaying) {
                        ...
                        a(p, !0, !1)
                    } else Mn(e, {onClose: f, prefix: s, desc: On, onKeyUp: l, onKeyDown: c});
                    break;
                case"wordUnderCursor":
                    var d = Yt(e, !1, !0, !1, !0), m = !0;
                    d || (d = Yt(e, !1, !0, !1, !1), m = !1);
                    if (!d) return;
                    var p = e.getLine(d.start.line).substring(d.start.ch, d.end.ch);
                    m && i ? p = "\\b" + p + "\\b" : p = jt(p), it.jumpList.cachedCursor = e.getCursor(), e.setCursor(d.start), a(p, !0, !1)
            }
        }, processEx: function (e, t, n) {
            function r(t) {
                it.exCommandHistoryController.pushInput(t), it.exCommandHistoryController.reset(), Wn.processCommand(e, t)
            }

            function i(t, n, r) {
                var i = v.keyName(t), s, o;
                if (i == "Esc" || i == "Ctrl-C" || i == "Ctrl-[" || i == "Backspace" && n == "") it.exCommandHistoryController.pushInput(n), it.exCommandHistoryController.reset(), v.e_stop(t), ft(e), r(), e.focus();
                i == "Up" || i == "Down" ? (v.e_stop(t), s = i == "Up" ? !0 : !1, o = t.target ? t.target.selectionEnd : 0, n = it.exCommandHistoryController.nextMatch(n, s) || "", r(n), o && t.target && (t.target.selectionEnd = t.target.selectionStart = Math.min(o, t.target.value.length))) : i == "Ctrl-U" ? (v.e_stop(t), r("")) : i != "Left" && i != "Right" && i != "Ctrl" && i != "Alt" && i != "Shift" && it.exCommandHistoryController.reset()
            }

            n.type == "keyToEx" ? Wn.processCommand(e, n.exArgs.input) : t.visualMode ? Mn(e, {
                onClose: r,
                prefix: ":",
                value: "'<,'>",
                onKeyDown: i,
            ...
            var n = t.inputState, r = n.motion, i = n.motionArgs || {}, s = n.operator, o = n.operatorArgs || {},
                u = n.registerName, a = t.sel, f = At(t.visualMode ? St(e, a.head) : e.getCursor("head")),
                l = At(t.visualMode ? St(e, a.anchor) : e.getCursor("anchor")), c = At(f), h = At(l), p, d, v;
            ...
            n.selectedCharacter && (i.selectedCharacter = o.selectedCharacter = n.selectedCharacter), i.repeat = v, ft(e);
            if (r) {
                var m = vt[r](e, f, i, t);
                t.lastMotion = vt[r];
                if (!m) return;
                if (i.toJumplist) {
                    ...
                    var g = it.jumpList, y = g.cachedCursor;
                    y ? (Zt(e, y, m), delete g.cachedCursor) : Zt(e, f, m)
                }
                m instanceof Array ? (d = m[0], p = m[1]) : p = m, p || (p = At(f));
                if (t.visualMode) {
                    if (!t.visualBlock || p.ch !== Infinity) p = St(e, p, t.visualBlock);
                    d && (d = St(e, d, !0)), d = d || h, a.anchor = d, a.head = p, Xt(e), fn(e, t, "<", Mt(d, p) ? d : p), fn(e, t, ">", Mt(d, p) ? p : d)
                } else s || (p = St(e, p), e.setCursor(p.line, p.ch))
            }
            if (s) {
                if (o.lastSel) {
                    d = h;
                    var b = o.lastSel, w = Math.abs(b.head.line - b.anchor.line), E = Math.abs(b.head.ch - b.anchor.ch);
                    b.visualLine ? p = S(h.line + w, h.ch) : b.visualBlock ? p = S(h.line + w, h.ch + E) : b.head.line == b.anchor.line ? p = S(h.line, h.ch + E) : p = S(h.line + w, h.ch), t.visualMode = !0, t.visualLine = b.visualLine, t.visualBlock = b.visualBlock, a = t.sel = {
                        anchor: d,
                        head: p
                    }, Xt(e)
                ...
                var x, T, N, C, k;
                if (t.visualMode) {
                    x = _t(a.head, a.anchor), T = Dt(a.head, a.anchor), N = t.visualLine || o.linewise, C = t.visualBlock ? "block" : N ? "line" : "char", k = Vt(e, {
                        anchor: x,
                        head: T
                    }, C);
                    if (N) {
                        var L = k.ranges;
                        if (C == "block") for (var A = 0; A < L.length; A++) L[A].head.ch = Ht(e, L[A].head.line); else C == "line" && (L[0].head = S(L[0].head.line + 1, 0))
                    }
                } else {
                    x = At(d || h), T = At(p || c);
                    if (Mt(T, x)) {
                    ...
                    N = i.linewise || o.linewise, N ? Qt(e, x, T) : i.forward && Kt(e, x, T), C = "char";
                    var M = !i.inclusive || N;
        ...
        moveToTopLine: function (e, t, n) {
            ...
            var t = In(e), n = Math.floor((t.top + t.bottom) * .5);
            ...
            for (var s = 0; s < n.repeat; s++) {
                ...
                for (var u in r.marks) {
                    if (!z(u)) continue;
                    var a = r.marks[u].find(), f = n.forward ? Mt(a, o) : Mt(o, a);
                    if (f) continue;
                    if (n.linewise && a.line == o.line) continue;
                    var l = Ot(o, i), c = n.forward ? Pt(o, a, i) : Pt(i, a, o);
                    if (l || c) i = a
                }
            }
            ...
            var o = n.repeat + (n.repeatOffset || 0), u = n.forward ? i.line + o : i.line - o, a = e.firstLine(),
                f = e.lastLine();
            ...
            return l && (n.forward ? u > l.start.row && (u = l.end.row + 1) : u = l.start.row), n.toFirstChar && (s = Gt(e.getLine(u)), r.lastHPos = s), r.lastHSPos = e.charCoords(S(u, s), "div").left, S(u, s)
            ...
            if (o.hitSide) if (n.forward) var u = e.charCoords(o, "div"), a = {top: u.top + 8, left: r.lastHSPos},
            ...
            var r = n.repeat, i = un(e, r, n.forward, n.selectedCharacter), s = n.forward ? -1 : 1;
            ...
            var i = n.repeat;
            return r.lastHPos = i - 1, r.lastHSPos = e.charCoords(t, "div").left, an(e, i)
        }, moveToEol: function (e, t, n, r, i) {
            var s = t, o = S(s.line + n.repeat - 1, Infinity), u = e.clipPos(o);
            ...
            return n.repeatIsExplicit && (r = n.repeat - e.getOption("firstLineNumber")), S(r, Gt(e.getLine(r)))
        }, textObjectManipulation: function (e, t, n, r) {
            var i = {"(": ")", ")": "(", "{": "}", "}": "{", "[": "]", "]": "[", "<": ">", ">": "<"},
                s = {"'": !0, '"': !0, "`": !0}, o = n.selectedCharacter;
            o == "b" ? o = "(" : o == "B" && (o = "{");
            var u = !n.textObjectInner, a;
            if (i[o]) a = pn(e, t, o, u); else if (s[o]) a = dn(e, t, o, u); else if (o === "W") a = Yt(e, u, !0, !0); else if (o === "w") a = Yt(e, u, !0, !1); else {
                if (o !== "p") return null;
            ...
            return e.state.vim.visualMode ? Wt(e, a.start, a.end) : [a.start, a.end]
        }, repeatLastCharacterSearch: function (e, t, n) {
            var r = it.lastCharacterSearch, i = n.repeat, s = n.forward === r.forward,
        ...
        change: function (e, t, n) {
            var r, i, s = e.state.vim, o = n[0].anchor, u = n[0].head;
            if (!s.visualMode) {
                i = e.getRange(o, u);
                var a = s.lastEditInputState || {};
                if (a.motion == "moveByWords" && !$(i)) {
                    var f = /\s+$/.exec(i);
                    f && a.motionArgs && a.motionArgs.forward && (u = Tt(u, 0, -f[0].length), i = i.slice(0, -f[0].length))
                }
                var l = new S(o.line - 1, Number.MAX_VALUE), c = e.firstLine() == e.lastLine();
                u.line > e.lastLine() && t.linewise && !c ? e.replaceRange("", l, u) : e.replaceRange("", o, u), t.linewise && (c || (e.setCursor(l), v.commands.newlineAndIndent(e)), o.ch = Number.MAX_VALUE), r = o
            ...
            it.registerController.pushText(t.registerName, "change", i, t.linewise, n.length > 1), wt.enterInsertMode(e, {head: r}, e.state.vim)
        }, "delete": function (e, t, n) {
            var r, i, s = e.state.vim;
            if (!s.visualBlock) {
                var o = n[0].anchor, u = n[0].head;
                t.linewise && u.line != e.firstLine() && o.line == e.lastLine() && o.line == u.line - 1 && (o.line == e.firstLine() ? o.ch = 0 : o = S(o.line - 1, Ht(e, o.line - 1))), i = e.getRange(o, u), e.replaceRange("", o, u), r = o, t.linewise && (r = vt.moveToFirstNonWhiteSpaceCharacter(e, o))
            } else {
                i = e.getSelection();
                var a = gt("", n.length);
                e.replaceSelections(a), r = n[0].anchor
            }
            it.registerController.pushText(t.registerName, "delete", i, t.linewise, s.visualBlock);
            var f = s.insertMode;
            return St(e, r, f)
        }, indent: function (e, t, n) {
            var r = e.state.vim, i = n[0].anchor.line, s = r.visualBlock ? n[n.length - 1].anchor.line : n[0].head.line,
            ...
            return e.execCommand("indentAuto"), vt.moveToFirstNonWhiteSpaceCharacter(e, n[0].anchor)
            ...
            return e.replaceSelections(o), t.shouldMoveCursor ? i : !e.state.vim.visualMode && t.linewise && n[0].anchor.line + 1 == n[0].head.line ? vt.moveToFirstNonWhiteSpaceCharacter(e, r) : t.linewise ? r : _t(n[0].anchor, n[0].head)
        }, yank: function (e, t, n, r) {
            var i = e.state.vim, s = e.getSelection(),
                o = i.visualMode ? _t(i.sel.anchor, i.sel.head, n[0].head, n[0].anchor) : r;
            return it.registerController.pushText(t.registerName, "yank", s, t.linewise, i.visualBlock), o
        }
    }, wt = {
        jumpListWalk: function (e, t, n) {
            if (n.visualMode) return;
            var r = t.repeat, i = t.forward, s = it.jumpList, o = s.move(e, i ? r : -r), u = o ? o.find() : undefined;
            u = u ? u : e.getCursor(), e.setCursor(u), e.ace.curOp.command.scrollIntoView = "center-animate"
        }, scroll: function (e, t, n) {
            if (n.visualMode) return;
            var r = t.repeat || 1, i = e.defaultTextHeight(), s = e.getScrollInfo().top, o = i * r,
                u = t.forward ? s + o : s - o, a = At(e.getCursor()), f = e.charCoords(a, "local");
            ...
            var n = e.getCursor().line, r = e.charCoords(S(n, 0), "local"), i = e.getScrollInfo().clientHeight,
                s = r.top, o = r.bottom - s;
            switch (t.position) {
                case"center":
                    s = s - i / 2 + o;
                    break;
            ...
            var r = t.selectedCharacter, i = t.repeat, s = it.macroModeState;
            r == "@" ? r = s.latestRegister : s.latestRegister = r;
            while (i--) Kn(e, n, s, r)
        }, enterMacroRecordMode: function (e, t) {
            var n = it.macroModeState, r = t.selectedCharacter;
            it.registerController.isValidRegister(r) && n.enterMacroRecordMode(e, r)
        }, toggleOverwrite: function (e) {
            e.state.overwrite ? (e.toggleOverwrite(!1), e.setOption("keyMap", "vim-insert"), v.signal(e, "vim-mode-change", {mode: "insert"})) : (e.toggleOverwrite(!0), e.setOption("keyMap", "vim-replace"), v.signal(e, "vim-mode-change", {mode: "replace"}))
            ...
            if (r == "eol") s = S(s.line, Ht(e, s.line)); else if (r == "bol") s = S(s.line, 0); else if (r == "charAfter") s = Tt(s, 0, 1); else if (r == "firstNonBlank") s = vt.moveToFirstNonWhiteSpaceCharacter(e, s); else if (r == "startOfSelectedArea") {
                if (!n.visualMode) return;
                n.visualBlock ? (s = S(Math.min(i.head.line, i.anchor.line), Math.min(i.head.ch, i.anchor.ch)), o = Math.abs(i.head.line - i.anchor.line) + 1) : i.head.line < i.anchor.line ? s = i.head : s = S(i.anchor.line, 0)
            } else if (r == "endOfSelectedArea") {
                if (!n.visualMode) return;
                n.visualBlock ? (s = S(Math.min(i.head.line, i.anchor.line), Math.max(i.head.ch + 1, i.anchor.ch)), o = Math.abs(i.head.line - i.anchor.line) + 1) : i.head.line >= i.anchor.line ? s = Tt(i.head, 0, 1) : s = S(i.anchor.line, 0)
            } else if (r == "inplace") {
                if (n.visualMode) return
            } else r == "lastEdit" && (s = Rn(e) || s);
            e.setOption("disableInput", !1), t && t.replace ? (e.toggleOverwrite(!0), e.setOption("keyMap", "vim-replace"), v.signal(e, "vim-mode-change", {mode: "replace"})) : (e.toggleOverwrite(!1), e.setOption("keyMap", "vim-insert"), v.signal(e, "vim-mode-change", {mode: "insert"})), it.macroModeState.isPlaying || (e.on("change", Zn), v.on(e.getInputField(), "keydown", ir)), n.visualMode && Jt(e), qt(e, s, o)
            ...
            }), Xt(e)) : Jt(e) : (n.visualMode = !0, n.visualLine = !!t.linewise, n.visualBlock = !!t.blockwise, s = St(e, S(i.line, i.ch + r - 1), !0), n.sel = {
                anchor: i,
                head: s
            }, v.signal(e, "vim-mode-change", {
                mode: "visual",
                subMode: n.visualLine ? "linewise" : n.visualBlock ? "blockwise" : ""
            }), Xt(e), fn(e, n, "<", _t(i, s)), fn(e, n, ">", Dt(i, s)))
            ...
            if (r) {
                ...
                n.sel = {
                    anchor: i,
                    head: s
                }, n.visualMode = !0, n.visualLine = r.visualLine, n.visualBlock = r.visualBlock, Xt(e), fn(e, n, "<", _t(i, s)), fn(e, n, ">", Dt(i, s)), v.signal(e, "vim-mode-change", {
                    mode: "visual",
                    subMode: n.visualLine ? "linewise" : n.visualBlock ? "blockwise" : ""
                })
            }
            ...
            for (var a = r.line; a < i.line; a++) {
                u = Ht(e, r.line);
                var s = S(r.line + 1, Ht(e, r.line + 1)), f = e.getRange(r, s);
            ...
            if (r.line === e.firstLine() && !t.after) e.replaceRange("\n", S(e.firstLine(), 0)), e.setCursor(e.firstLine(), 0); else {
                r.line = t.after ? r.line : r.line - 1, r.ch = Ht(e, r.line), e.setCursor(r);
            ...
            var r = At(e.getCursor()), i = it.registerController.getRegister(t.registerName), s = i.toString();
            if (!s) return;
            if (t.matchIndent) {
                var o = e.getOption("tabSize"), u = function (e) {
                    ...
                    h = u(s.match(/^\s*/)[0]), s = l.replace(/^\s*/gm, function (t) {
                        var n = f + (u(t) - h);
                        if (n < 0) return "";
            ...
            } else p ? n.visualMode ? s = n.visualLine ? s.slice(0, -1) : "\n" + s.slice(0, s.length - 1) + "\n" : t.after ? (s = "\n" + s.slice(0, s.length - 1), r.ch = Ht(e, r.line)) : r.ch = 0 : r.ch += t.after ? 1 : 0;
            var m, g;
            if (n.visualMode) {
                n.lastPastedText = s;
                var y, b = Ut(e, n), w = b[0], E = b[1], x = e.getSelection(), T = e.listSelections(),
                    N = (new Array(T.length)).join("1").split("1");
                n.lastSelection && (y = n.lastSelection.headMark.find()), it.registerController.unnamedRegister.setText(x), d ? (e.replaceSelections(N), E = S(w.line + s.length - 1, w.ch), e.setCursor(w), It(e, E), e.replaceSelections(s), m = w) : n.visualBlock ? (e.replaceSelections(N), e.setCursor(w), e.replaceRange(s, w, w), m = w) : (e.replaceRange(s, w, E), m = e.posFromIndex(e.indexFromPos(w) + s.length - 1)), y && (n.lastSelection.headMark = e.setBookmark(y)), p && (m.ch = 0)
            } else if (d) {
                e.setCursor(r);
                ...
                e.setCursor(r), It(e, S(r.line + s.length - 1, r.ch)), e.replaceSelections(s), m = r
            } else e.replaceRange(s, r), p && t.after ? m = S(r.line + 1, Gt(e.getLine(r.line + 1))) : p && !t.after ? m = S(r.line, Gt(e.getLine(r.line))) : !p && t.after ? (g = e.indexFromPos(r), m = e.posFromIndex(g + s.length - 1)) : (g = e.indexFromPos(r), m = e.posFromIndex(g + s.length));
            n.visualMode && Jt(e, !1), e.setCursor(m)
        }, undo: function (e, t) {
            e.operation(function () {
                Lt(e, v.commands.undo, t.repeat)(), e.setCursor(e.getCursor("anchor"))
            })
        }, redo: function (e, t) {
            ...
            if (n.visualMode) i = e.getCursor("start"), o = e.getCursor("end"); else {
                var a = e.getLine(i.line);
                s = i.ch + t.repeat, s > a.length && (s = a.length), o = S(i.line, s)
            }
            if (r == "\n") n.visualMode || e.replaceRange("", i, o), (v.commands.newlineAndIndentContinueComment || v.commands.newlineAndIndent)(e); else {
                ...
                n.visualMode ? (i = Mt(u[0].anchor, u[0].head) ? u[0].anchor : u[0].head, e.setCursor(i), Jt(e, !1)) : e.setCursor(Tt(o, 0, -1))
            }
        }, incrementNumberToken: function (e, t) {
            var n = e.getCursor(), r = e.getLine(n.line), i = /(-?)(?:(0x)([\da-f]+)|(0b|0|)(\d+))/gi, s, o, u, a;
            ...
            if (!s) return;
            var f = s[2] || s[4], l = s[3] || s[5], c = t.increase ? 1 : -1,
                h = {"0b": 2, 0: 8, "": 10, "0x": 16}[f.toLowerCase()], p = parseInt(s[1] + l, h) + c * t.repeat;
            a = p.toString(h);
            var d = f ? (new Array(l.length - a.length + 1 + s[1].length)).join("0") : "";
            a.charAt(0) === "-" ? a = "-" + f + d + a.substr(1) : a = f + d + a;
            var v = S(n.line, o), m = S(n.line, u);
            e.replaceRange(a, v, m), e.setCursor(S(n.line, o + a.length - 1))
        }, repeatLastEdit: function (e, t, n) {
            var r = n.lastEditInputState;
            if (!r) return;
            var i = t.repeat;
            i && t.repeatIsExplicit ? n.lastEditInputState.repeatOverride = i : i = n.lastEditInputState.repeatOverride || i, sr(e, n, i, !1)
        }, indent: function (e, t) {
    ...
    Un.prototype = {
        processCommand: function (e, t, n) {
            ...
            var r = e.state.vim, i = it.registerController.getRegister(":"), s = i.toString();
            r.visualMode && Jt(e);
            ...
            switch (t.next()) {
                ...
                case"'":
                    var r = t.next(), i = qn(e, e.state.vim, r);
            ...
            var r = n.argDelimiter || /\s+/, i = Bt(t.argString).split(r);
            ...
            for (var e = 0; e < E.length; e++) {
                var t = E[e], n = t.shortName || t.name;
            ...
            if (e != ":" && e.charAt(0) == ":") {
                ...
                var r = e;
                for (var i = 0; i < b.length; i++) if (r == b[i].keys && b[i].context === t) {
                    b.splice(i, 1);
                    return
                }
            }
    ...
    var zn = {
        colorscheme: function (e, t) {
            ...
            var i = n[0].split("="), s = i[0], o = i[1], u = !1;
            ...
            if (!a && o === undefined || u) {
                var f = Z(s, e, r);
                f instanceof Error ? Ln(e, f.message) : f === !0 || f === !1 ? Ln(e, " " + (f ? "" : "no") + s) : Ln(e, "  " + s + "=" + f)
            } else {
                var l = Y(s, o, e, r);
            ...
            var n = t.args, r = it.registerController.registers, i = "----------Registers----------<br><br>";
            if (!n) for (var s in r) {
                var o = r[s].toString();
                o.length && (i += '"' + s + "    " + o + "<br>")
            } else {
                ...
                if (t.argString) {
                    ...
                    if (u[1]) {
                        ...
                        var a = u[1].indexOf("d") != -1 || u[1].indexOf("n") != -1 && 1,
                            f = u[1].indexOf("x") != -1 && 1, l = u[1].indexOf("o") != -1 && 1;
            ...
            function E(e, t) {
                ...
                var o = s && d.exec(e), u = s && d.exec(t);
                return o ? (o = parseInt((o[1] + o[2]).toLowerCase(), m), u = parseInt((u[1] + u[2]).toLowerCase(), m), o - u) : e < t ? -1 : 1
            }
            ...
            var f = t.line || e.firstLine(), l = t.lineEnd || t.line || e.lastLine();
            if (f == l) return;
            var c = S(f, 0), h = S(l, Ht(e, l)), p = e.getRange(c, h).split("\n"),
                d = o ? o : s == "decimal" ? /(-?)([\d]+)/ : s == "hex" ? /(-?)(?:0x)?([0-9a-f]+)/i : s == "octal" ? /([0-7]+)/ : null,
                m = s == "decimal" ? 10 : s == "hex" ? 16 : s == "octal" ? 8 : null, g = [], y = [];
            if (s || o) for (var b = 0; b < p.length; b++) {
                var w = o ? p[b].match(o) : null;
                w && w[0] != "" ? g.push(w) : !o && d.exec(p[b]) ? g.push(p[b]) : y.push(p[b])
            } else y = p;
            g.sort(o ? x : E);
            if (o) for (var b = 0; b < g.length; b++) g[b] = g[b].input; else s || y.sort(E);
            p = n ? g.concat(y) : y.concat(g);
            if (i) {
                var T = p, N;
                p = [];
                for (var b = 0; b < T.length; b++) T[b] != N && p.push(T[b]), N = T[b]
            }
            ...
            var r = t.line !== undefined ? t.line : e.firstLine(), i = t.lineEnd || t.line || e.lastLine(), s = yn(n),
                o = n, u;
            ...
            var n = t.argString, r = n ? wn(n, n[0]) : [], i, s = "", o, u, a, f = !1, l = !1;
            if (r.length) i = r[0], Z("pcre") && i !== "" && (i = (new RegExp(i)).source), s = r[1], i && i[i.length - 1] === "$" && (i = i.slice(0, i.length - 1) + "\\n", s = s ? s + "\n" : "\n"), s !== undefined && (Z("pcre") ? s = Cn(s.replace(/([^\\])&/g, "$1$$&")) : s = Tn(s), it.lastSubstituteReplacePart = s), o = r[2] ? r[2].split(" ") : []; else if (n && n.length) {
                Ln(e, "Substitutions should be of the form :s/pattern/replace/");
                return
            }
            o && (u = o[0], a = parseInt(o[1]), u && (u.indexOf("c") != -1 && (f = !0, u.replace("c", "")), u.indexOf("g") != -1 && (l = !0, u.replace("g", "")), Z("pcre") ? i = i + "/" + u : i = i.replace(/\//g, "\\/") + "/" + u));
            if (i) try {
                Dn(e, i, !0, !0)
            } catch (c) {
            ...
            var h = mn(e), p = h.getQuery(), d = t.line !== undefined ? t.line : e.getCursor().line, v = t.lineEnd || d;
            d == e.firstLine() && v == e.lastLine() && (v = Infinity), a && (d = v, v = d + a - 1);
            var m = St(e, S(d, 0)), g = e.getSearchCursor(p, m);
            ...
            var t = At(e.getCursor()), n = t.line, r = e.getLine(n);
            ...
            var n = e.state.vim, r = new v.StringStream(Bt(t.argString));
            while (!r.eol()) {
                r.eatSpace();
                var i = r.pos;
                if (!r.match(/[a-zA-Z]/, !1)) {
    ...
    v.keyMap.vim = {
        ...
        detach: C,
        call: L
    }, G("insertModeEscKeysTimeout", 200, "number"), v.keyMap["vim-insert"] = {
        fallthrough: ["default"],
        attach: k,
        detach: C,
        call: L
    ...
    t.handler = {
        $id: "ace/keyboard/vim", drawCursor: function (e, t, n, r, s) {
            var u = this.state.vim || {}, a = n.characterWidth, f = n.lineHeight, l = t.top, c = t.left;
            if (!u.insertMode) {
            ...
            var s = e.editor, o = s.state.cm, u = hr(o);
            if (r == -1) return;
            ...
            if (n == "esc" && !u.insertMode && !u.visualMode && !o.ace.inMultiSelectMode) {
                var a = mn(o), f = a.getOverlay();
                f && o.removeOverlay(f)
            }
            if (t == -1 || t & 1 || t === 0 && n.length > 1) {
                var l = u.insertMode, h = ar(t, n, i || {});
                u.status == null && (u.status = "");
                var p = cr(o, h, "user");
                u = hr(o), p && u.status != null ? u.status += h : u.status == null && (u.status = ""), o._signal("changeStatus");
                if (!p && (t != -1 || l)) return;
            ...
            e.state || (e.state = {});
            var t = new v(e);
            e.state.cm = t, e.$vimModeHandler = this, v.keyMap.vim.attach(t), hr(t).status = null, t.on("vim-command-done", function () {
                if (t.virtualSelectionMode()) return;
                hr(t).status = null, t.ace._signal("changeStatus"), t.ace.session.markUndoGroup()
            ...
            var t = e.state.cm;
            v.keyMap.vim.detach(t), t.destroy(), e.state.cm = null, e.$vimModeHandler = null, e.renderer.$cursorLayer.drawCursor = null, e.renderer.setStyle("normal-mode", !1), e.textInput.setCommandMode(!1), e.renderer.$keepTextAreaAtCursor = !0
        }, getStatusText: function (e) {
            var t = e.state.cm, n = hr(t);
        ...
        e.vimCmd = t, e.ace.inVirtualSelectionMode ? e.ace.on("beforeEndOperation", pr) : pr(null, e.ace)
    }, wt.fold = function (e, t, n) {
        e.ace.execCommand(["toggleFoldWidget", "toggleFoldWidget", "foldOther", "unfoldall"][(t.all ? 2 : 0) + (t.open ? 1 : 0)])
    }, t.handler.defaultKeymap = b, t.handler.actions = wt, t.Vim = x
});
(function () {
