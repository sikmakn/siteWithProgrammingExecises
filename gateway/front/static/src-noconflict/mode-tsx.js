ace.define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./javascript_highlight_rules").JavaScriptHighlightRules, s = function (e) {
        var t = [{
        ...
        }, {token: "keyword", regex: "\\b(?:super|export|import|keyof|infer)\\b"}, {
        ...
        }], n = (new i({jsx: (e && e.jsx) == 1})).getRules();
        n.no_regex = t.concat(n.no_regex), this.$rules = n
    };
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./javascript").Mode, s = e("./typescript_highlight_rules").TypeScriptHighlightRules,
        o = e("./behaviour/cstyle").CstyleBehaviour, u = e("./folding/cstyle").FoldMode,
        a = e("./matching_brace_outdent").MatchingBraceOutdent, f = function () {
...
}), ace.define("ace/mode/tsx", ["require", "exports", "module", "ace/lib/oop", "ace/mode/typescript"], function (e, t, n) {
    "use strict";
    var r = e("../lib/oop"), i = e("./typescript").Mode, s = function () {
        i.call(this), this.$highlightRuleConfig = {jsx: !0}
    };
